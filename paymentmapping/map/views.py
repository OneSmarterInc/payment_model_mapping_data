...
from .models import MappingData,Column_mapping_data,company_onbording_payment,sub_company_onbording_payment,vendor_onbording_payment
from .serializers import post_mapping_serializer,get_mapping_serializer,column_serializer,company_onbording_payment_serializer,sub_company_onbording_payment_serializer,vendor_onbording_payment_serializer
from rest_framework import status
...
class get_sub_company_onboarding_details(APIView):
    def get(self,request):
        db_data = sub_company_onbording_payment.objects.all()
