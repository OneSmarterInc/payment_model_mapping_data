...
from .views import upload_csv,get_column_names,get_mapping_data,post_mapping_data,edit_CompanyOnboardingPaymentDetail,edit_SubCompanyOnboardingPaymentDetail,edit_VendorOnboardingPaymentDetail,delete_CompanyOnboardingPaymentDetail,delete_SubCompanyOnboardingPaymentDetail,delete_VendorOnboardingPaymentDetail,get_company_onboarding_details,get_sub_company_onboarding_details,get_vendor_onboarding_details
urlpatterns = [
